    ...
    if (kbhitUart0())
    {
        ...
        else
        {
            ...
            else if (strcmp(token, "mqtt") == 0)
            {
                ...
                if (token == NULL)
                {
                    putsUart0("Error in mqtt argument\r\n");
                    return;
                }
            ...
            else if (strcmp(token, "set") == 0)
            {
                ...
                if (token == NULL)
                {
                    putsUart0("Error in set argument\r\n");
                    return;
                }
                ...
                else if (strcmp(token, "time") == 0)
                {
                    for (i = 0; i < IP_ADD_LENGTH; i++)
                    {
                        ...
                        if (token == NULL)
                        {
                            putsUart0("Invalid time server address\r\n");
                            return;
                        }
                        ip[i] = asciiToUint8(token);
                    }
                ...
                else if (strcmp(token, "mqtt") == 0)
                {
                    for (i = 0; i < IP_ADD_LENGTH; i++)
                    {
                        ...
                        if (token == NULL)
                        {
                            putsUart0("Invalid MQTT broker address\r\n");
                            return;
                        }
                        ip[i] = asciiToUint8(token);
                    }
...
int main(void)
{
    ...
    setEtherMacAddress(2, 3, 4, 5, 6, 119);
